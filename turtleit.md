...
The youtube videos show the building up of this project using the (now no longer available) trinket online Python editor. To make this project you should use your own Python editor and copy and paste in the starter code which is [here](turtle_it_starter.py). You will also need two image files. Follow the links to these, [frog_images.zip](frog_images.zip)
