...
The Python projects were all built up on [trinket.io](https://trinket.io) website, which is, unfortunately, no longer available. To make your own version of these projects you should use the replacement trinket platform hosted by Strive Math. You can make an account at this site by going to [trinket.strivemath.org/signup](https://trinket.strivemath.org/signup). Make sure you are logged in before watching the videos.
